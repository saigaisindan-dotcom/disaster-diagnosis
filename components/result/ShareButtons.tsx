...
export default function ShareButtons({ risk, summaryMessage, prefecture, city }: Props) {
  ...
  const shareText = `【災害リスク診断】${prefecture}${city}の診断結果\n地震:${risk.earthquake}点 / 津波:${risk.tsunami}点 / 火山灰:${risk.ash}点\n${summaryMessage}\n#防災 #備蓄 #災害対策`;
